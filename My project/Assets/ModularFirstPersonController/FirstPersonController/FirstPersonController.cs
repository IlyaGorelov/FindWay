...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(Input.GetKey(jumpKey) && !States.isPaused)
        {
            Jump();
        }
        ...
        if (Input.GetKey(crouchKey) && holdToCrouch && !States.isPaused)
        {
            Crouch();
        }
    ...
    void FixedUpdate()
    {
        ...
        if (playerCanMove && !States.isPaused)
        {
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.sprintSpeed = EditorGUILayout.Slider(new GUIContent("Sprint Speed", "Determines how fast the player will move while sprinting."), fpc.sprintSpeed, fpc.walkSpeed, 40f);
